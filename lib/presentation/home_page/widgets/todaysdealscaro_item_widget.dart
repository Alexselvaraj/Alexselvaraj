...
class TodaysdealscaroItemWidget extends StatelessWidget {
  TodaysdealscaroItemWidget(
    this.todaysdealscaroItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  TodaysdealscaroItemModel todaysdealscaroItemModelObj;
