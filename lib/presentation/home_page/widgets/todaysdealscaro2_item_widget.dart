...
class Todaysdealscaro2ItemWidget extends StatelessWidget {
  Todaysdealscaro2ItemWidget(
    this.todaysdealscaro2ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Todaysdealscaro2ItemModel todaysdealscaro2ItemModelObj;
